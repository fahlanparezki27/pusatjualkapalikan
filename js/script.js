...
const products = [
  ...
  },
  {
    ...
    Lebar: "9,5m",
    Tinggi: "4,5m",
    thumbnails: ["img/Pekalongan/Galangan Bintang Mumbul Wibowo/18.1.jpg", "img/Pekalongan/Galangan Bintang Mumbul Wibowo/21.pngg", "img/Pekalongan/Galangan Bintang Mumbul Wibowo/22.png", "img/Pekalongan/Galangan Bintang Mumbul Wibowo/23.png" ]
  },

  {
    ...
    Lebar: "8,5m",
    Tinggi: "9m",
    thumbnails: ["img/Pekalongan/Galangan Wiwik/9.jpg", "img/Pekalongan/Galangan Wiwik/3.jpg", "img/Pekalongan/Galangan Wiwik/6.jpg", "img/Pekalongan/Galangan Wiwik/.jpg" ]
  },

  {
    ...
    Lebar: "9,5m",
    Tinggi: "9m",
    thumbnails: ["img/Pekalongan/Galangan Wiwik/5.jpg", "img/Pekalongan/Galangan Wiwik/7.jpg", "img/Pekalongan/Galangan Wiwik/1.jpg", ]
  },

  {
    ...
    Lebar: "9,5m",
    Tinggi: "4,5m",
    thumbnails: ["img/Batang/CV. Berkah Mandiri/12.jpg", "img/Batang/CV. Berkah Mandiri/13.jpg", "img/Pekalongan/Galangan Wiwik.jpg", ]
  },

  {
    ...
    Lebar: "9,5m",
    Tinggi: "4,5m",
    thumbnails: ["img/Batang/CV. Berkah Mandiri/17.jpg", "img/Batang/CV. Berkah Mandiri/18.jpg", "img/Pekalongan/Galangan Wiwik.jpg", ]
  },

  {
    ...
    Lebar: "5m",
    Tinggi: "1,6-2m",
    thumbnails: ["img/Batang/Galangan NoMarine/4.jpg", "img/Batang/Galangan NoMarine/3.jpg", "img/Batang/Galangan NoMarine/2.jpg", ]
  },

  {
    ...
    Lebar: "5m",
    Tinggi: "1,6-2m",
    thumbnails: ["img/Batang/Galangan NoMarine/5.jpg", "img/Batang/Galangan NoMarine/1.jpg", "img/Batang/Galangan NoMarine.jpg", ]
  },

  {
    ...
    Lebar: "6,5m",
    Tinggi: "6m",
    thumbnails: ["img/Rembang/CV. Soyo Mandiri/3.jpg", "img/Rembang/CV. Soyo Mandiri/4.jpg", "img/Rembang/CV. Soyo Mandiri/2.jpg", ]
  },

  {
    ...
    Lebar: "6,5m",
    Tinggi: "6m",
    thumbnails: ["img/Rembang/CV. Soyo Mandiri/4.jpg", "img/Rembang/CV. Soyo Mandiri/3.jpg", "img/Rembang/CV. Soyo Mandiri/1.jpg", ]
  },

  {
    id: 11,
    name: "Kapal Ikan CV. Tambah Barokah",
    image: "img/Rembang/CV. Tambah Barokah/1.jpg",
    Type: "Kapal Ikan",
    Capacity: "35-60 GT",
    price: "Langsung ke WA",
    Panjang: "15m",
    ...
    Lebar: "6,5m",
    Tinggi: "6m",
    thumbnails: ["img/Rembang/CV. Tambah Barokah/1.jpg", "img/Rembang/CV. Tambah Barokah/5.jpg", "img/Rembang/CV. Tambah Barokah/2.jpg", ]
  },

  {
    id: 12,
    name: "Kapal Ikan CV. Tambah Barokah",
    image: "img/Rembang/CV. Tambah Barokah/3.jpg",
    Type: "Kapal Ikan",
    Capacity: "35-60 GT",
    price: "Langsung ke WA",
    Panjang: "15m",
    ...
    Lebar: "6,5m",
    Tinggi: "6m",
    thumbnails: ["img/Rembang/CV. Tambah Barokah/3.jpg", "img/Rembang/CV. Tambah Barokah/4.jpg", "img/Rembang/CV. Tambah Barokah/1.jpg", ]
  }
